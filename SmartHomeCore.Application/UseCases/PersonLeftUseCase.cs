...
public class PersonLeftUseCase(House house, IDomainEventDispatcher domainEventDispatcher) 
    : UseCase(house, domainEventDispatcher)
{
    ...
    {
        _house.MarkPersonAsAway(PersonId ?? throw new NullReferenceException(PersonId));
