...
//   At: 2025-04-29T17:56:31.5432630-04:00
//
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_camera_notifications</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseCameraNotifications => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_camera_notifications");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_devices_cameras</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseDevicesCameras => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_devices_cameras");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_devices_front_door_lock</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseDevicesFrontDoorLock => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_devices_front_door_lock");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_devices_garage_door</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseDevicesGarageDoor => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_devices_garage_door");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_devices_shawn</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseDevicesShawn => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_devices_shawn");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_do_not_disturb</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomDevicesDoNotDisturb => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_do_not_disturb");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_mac_book_pro</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomDevicesMacBookPro => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_mac_book_pro");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_motion_sensor</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomDevicesMotionSensor => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_motion_sensor");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_shawns_room_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomDevicesShawnsRoomState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_devices_shawns_room_state");
