...
//   At: 2025-05-09T17:43:52.6906220-04:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Doorbell Pet</summary>
    public BinarySensorEntity DoorbellPet => new(_haContext, "binary_sensor.doorbell_pet");
    ///<summary>Doorbell Vehicle</summary>
    public BinarySensorEntity DoorbellVehicle => new(_haContext, "binary_sensor.doorbell_vehicle");
    ...
    ///<summary>LUMI lumi.sensor_wleak.aq1</summary>
    ...
    ///<summary>Shawn&apos;s Room Occupied</summary>
    public BinarySensorEntity ShawnsroomOccupiedNetdaemon => new(_haContext, "binary_sensor.shawnsroom_occupied_netdaemon");
...
public partial class ButtonEntities
{
    ...
    ///<summary>H6022_5741 Request Platform API State</summary>
    public ButtonEntity H60225741RequestPlatformApiState => new(_haContext, "button.h6022_5741_request_platform_api_state");
    ...
    ///<summary>Garage Door Close</summary>
    public ButtonEntity HouseGarageDoorCloseNetdaemon => new(_haContext, "button.house_garage_door_close_netdaemon");
    ///<summary>Garage Door Open</summary>
    public ButtonEntity HouseGarageDoorOpenNetdaemon => new(_haContext, "button.house_garage_door_open_netdaemon");
...
public partial class NumberEntities
{
    ...
    ///<summary>Doorbell AI pet sensitivity</summary>
    public NumberEntity DoorbellAiPetSensitivity => new(_haContext, "number.doorbell_ai_pet_sensitivity");
    ///<summary>Doorbell AI vehicle sensitivity</summary>
    public NumberEntity DoorbellAiVehicleSensitivity => new(_haContext, "number.doorbell_ai_vehicle_sensitivity");
...
public partial class ScriptEntities
{
    ...
    ///<summary>House sleep (siri shortcut)</summary>
    ...
    ///<summary>Turn shawn&apos;s office off (siri shortcut)</summary>
...
public partial class SelectEntities
{
    ...
    ///<summary>Bedroom Room State Select</summary>
    public SelectEntity BedroomStateNetdaemon => new(_haContext, "select.bedroom_state_netdaemon");
    ...
    public SelectEntity HouseStateNetdaemon => new(_haContext, "select.house_state_netdaemon");
    ///<summary>Justin Purifier Night light level</summary>
    public SelectEntity JustinPurifierNightLightLevel => new(_haContext, "select.justin_purifier_night_light_level");
    ///<summary>Justin&apos;s Room State Select</summary>
    public SelectEntity JustinroomStateNetdaemon => new(_haContext, "select.justinroom_state_netdaemon");
    ...
    ///<summary>Main Purifier Night light level</summary>
    public SelectEntity MainPurifierNightLightLevel => new(_haContext, "select.main_purifier_night_light_level");
    ///<summary>Main Room State Select</summary>
    public SelectEntity MainroomStateSelectNetdaemon => new(_haContext, "select.mainroom_state_select_netdaemon");
    ...
    ///<summary>Reolink Chime Vehicle ringtone</summary>
    public SelectEntity ReolinkChimeVehicleRingtone => new(_haContext, "select.reolink_chime_vehicle_ringtone");
    ...
    ///<summary>Shawn Purifier Night light level</summary>
    public SelectEntity ShawnPurifierNightLightLevel => new(_haContext, "select.shawn_purifier_night_light_level");
    ///<summary>Shawn&apos;s Room State Select</summary>
    public SelectEntity ShawnroomStateNetdaemon => new(_haContext, "select.shawnroom_state_netdaemon");
...
public partial class SensorEntities
{
    ...
    ///<summary>DESKTOP-TCFUKDG DESKTOP-TCFUKDG_lastactive</summary>
    public SensorEntity DesktopTcfukdgDesktopTcfukdgLastactive => new(_haContext, "sensor.desktop_tcfukdg_desktop_tcfukdg_lastactive");
    ...
    ///<summary>H6022_5741 Status</summary>
    public SensorEntity H60225741Status => new(_haContext, "sensor.h6022_5741_status");
    ...
    ///<summary>Shawn&apos;s Room Last Motion</summary>
    public SensorEntity ShawnsroomLastMotionNetdaemon => new(_haContext, "sensor.shawnsroom_last_motion_netdaemon");
...
public partial class SwitchEntities
{
    ...
    ///<summary>Camera notifications</summary>
    public SwitchEntity HouseCameraNotificationsNetdaemon => new(_haContext, "switch.house_camera_notifications_netdaemon");
    ///<summary>Water Leak detected</summary>
    public SwitchEntity HouseWaterLeakDetectedNetdaemon => new(_haContext, "switch.house_water_leak_detected_netdaemon");
    ...
    ///<summary>Main Room State Switch</summary>
    public SwitchEntity MainroomStateSwitchNetdaemon => new(_haContext, "switch.mainroom_state_switch_netdaemon");
    ...
    ///<summary>Shawn&apos;s not disturb switch</summary>
    public SwitchEntity ShawnroomDndNetdaemon => new(_haContext, "switch.shawnroom_dnd_netdaemon");
    ///<summary>Shawn&apos;s Room State Switch</summary>
    public SwitchEntity ShawnroomStateNetdaemon => new(_haContext, "switch.shawnroom_state_netdaemon");
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_bedroom_bedroom_room_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsBedroomBedroomRoomState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_bedroom_bedroom_room_state");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_cameras</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseCameras => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_cameras");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_front_door_lock</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseFrontDoorLock => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_front_door_lock");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_garage_door</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseGarageDoor => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_garage_door");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_house_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseHouseState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_house_state");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_main_room_camera</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseMainRoomCamera => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_main_room_camera");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_people</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHousePeople => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_people");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_silence_camera_notifications_switch</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseSilenceCameraNotificationsSwitch => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_silence_camera_notifications_switch");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_timer</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseTimer => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_timer");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_house_water_leak_detectors</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsHouseWaterLeakDetectors => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_house_water_leak_detectors");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_justin_room_justins_room_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsJustinRoomJustinsRoomState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_justin_room_justins_room_state");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_main_room_main_room_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsMainRoomMainRoomState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_main_room_main_room_state");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_do_not_disturb</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomDoNotDisturb => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_do_not_disturb");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_mac_book_pro</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomMacBookPro => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_mac_book_pro");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_motion_sensor</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomMotionSensor => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_motion_sensor");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_shawn_room_shawns_room_state</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsShawnRoomShawnsRoomState => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_shawn_room_shawns_room_state");
    ///<summary>netdaemon_mqtt_entity_state_manager</summary>
    public InputBooleanEntity NetdaemonMqttEntityStateManager => new(_haContext, "input_boolean.netdaemon_mqtt_entity_state_manager");
    ///<summary>netdaemon_net_daemon_apps_apps_bedroom_bedroom_room_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsBedroomBedroomRoomState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_bedroom_bedroom_room_state");
    ///<summary>netdaemon_net_daemon_apps_apps_house_cameras</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseCameras => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_cameras");
    ///<summary>netdaemon_net_daemon_apps_apps_house_front_door_lock</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseFrontDoorLock => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_front_door_lock");
    ///<summary>netdaemon_net_daemon_apps_apps_house_garage_door</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseGarageDoor => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_garage_door");
    ///<summary>netdaemon_net_daemon_apps_apps_house_house_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseHouseState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_house_state");
    ///<summary>netdaemon_net_daemon_apps_apps_house_main_room_camera</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseMainRoomCamera => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_main_room_camera");
    ///<summary>netdaemon_net_daemon_apps_apps_house_people</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHousePeople => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_people");
    ///<summary>netdaemon_net_daemon_apps_apps_house_silence_camera_notifications_switch</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseSilenceCameraNotificationsSwitch => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_silence_camera_notifications_switch");
    ///<summary>netdaemon_net_daemon_apps_apps_house_timer</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseTimer => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_timer");
    ///<summary>netdaemon_net_daemon_apps_apps_house_water_leak_detectors</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsHouseWaterLeakDetectors => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_house_water_leak_detectors");
    ///<summary>netdaemon_net_daemon_apps_apps_justin_room_justins_room_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsJustinRoomJustinsRoomState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_justin_room_justins_room_state");
    ///<summary>netdaemon_net_daemon_apps_apps_main_room_main_room_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsMainRoomMainRoomState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_main_room_main_room_state");
    ///<summary>netdaemon_net_daemon_apps_apps_shawn_room_do_not_disturb</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsShawnRoomDoNotDisturb => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_shawn_room_do_not_disturb");
    ///<summary>netdaemon_net_daemon_apps_apps_shawn_room_mac_book_pro</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsShawnRoomMacBookPro => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_shawn_room_mac_book_pro");
    ///<summary>netdaemon_net_daemon_apps_apps_shawn_room_motion_sensor</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsShawnRoomMotionSensor => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_shawn_room_motion_sensor");
    ///<summary>netdaemon_net_daemon_apps_apps_shawn_room_shawns_room_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsShawnRoomShawnsRoomState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_shawn_room_shawns_room_state");
}
...
public partial class BondServices
{
    ...
    ///<summary>Starts decreasing the brightness of the light (deprecated).</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Starts increasing the brightness of the light (deprecated).</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Stops any in-progress action and empty the queue (deprecated).</summary>
    ///<param name="target">The target for this service call</param>
...
public partial class EcovacsServices
{
    ...
    ///<summary>Retrieves a raw response containing the positions of the chargers and the device itself.</summary>
    ///<param name="target">The target for this service call</param>
...
public partial class SonosServices
{
    ...
    ///<summary>Starts playing the queue from the first item.</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Restores a snapshot of a media player.</summary>
    ...
    ///<param name="withGroup">Whether the group layout and the state of other speakers in the group should also be restored.</param>
    ...
    ///<summary>Takes a snapshot of a media player.</summary>
    ...
    ///<param name="withGroup">Whether the snapshot should include the group layout and the state of other speakers in the group.</param>
    ...
    ///<summary>Updates an alarm with new time and volume settings.</summary>
    ///<param name="alarmId">The ID of the alarm to be updated.</param>
    ///<param name="time">The time for the alarm. eg: 07:00</param>
    ///<param name="volume">The alarm volume level.</param>
    ///<param name="enabled">Whether or not to enable the alarm.</param>
    ///<param name="includeLinkedZones">Whether the alarm also plays on grouped players.</param>
...
public partial record SonosRestoreParameters
{
    ...
    ///<summary>Whether the group layout and the state of other speakers in the group should also be restored.</summary>
...
public partial record SonosSnapshotParameters
{
    ...
    ///<summary>Whether the snapshot should include the group layout and the state of other speakers in the group.</summary>
    [JsonPropertyName("with_group")]
    public bool? WithGroup { get; init; }
}
...
{
    ///<summary>The ID of the alarm to be updated.</summary>
    [JsonPropertyName("alarm_id")]
    public double? AlarmId { get; init; }

    ///<summary>The time for the alarm. eg: 07:00</summary>
    [JsonPropertyName("time")]
    public TimeOnly? Time { get; init; }

    ///<summary>The alarm volume level.</summary>
    [JsonPropertyName("volume")]
    public double? Volume { get; init; }

    ///<summary>Whether or not to enable the alarm.</summary>
    [JsonPropertyName("enabled")]
    public bool? Enabled { get; init; }

    ///<summary>Whether the alarm also plays on grouped players.</summary>
...
public partial class TodoistServices
{
    ...
    ///<param name="assignee">The username of a shared project&apos;s member to assign this task to. eg: username</param>
    ///<param name="priority">The priority of this task, from 1 (normal) to 4 (urgent).</param>
    ///<param name="dueDateString">The time this task is due, in natural language. eg: Tomorrow</param>
    ///<param name="dueDateLang">The language of &apos;Due date string&apos;.</param>
    ...
    ///<param name="reminderDateString">When the user should be reminded of this task, in natural language. eg: Tomorrow</param>
    ///<param name="reminderDateLang">The language of &apos;Reminder date string&apos;.</param>
    ///<param name="reminderDate">When the user should be reminded of this task, in format YYYY-MM-DDTHH:MM:SS, in UTC timezone. eg: 2019-10-22T10:30:00</param>
...
public partial record TodoistNewTaskParameters
{
    ...
    ///<summary>The username of a shared project&apos;s member to assign this task to. eg: username</summary>
    ...
    ///<summary>The time this task is due, in natural language. eg: Tomorrow</summary>
    [JsonPropertyName("due_date_string")]
    public string? DueDateString { get; init; }

    ///<summary>The language of &apos;Due date string&apos;.</summary>
    ...
    ///<summary>When the user should be reminded of this task, in natural language. eg: Tomorrow</summary>
    [JsonPropertyName("reminder_date_string")]
    public string? ReminderDateString { get; init; }

    ///<summary>The language of &apos;Reminder date string&apos;.</summary>
    [JsonPropertyName("reminder_date_lang")]
    public object? ReminderDateLang { get; init; }

    ///<summary>When the user should be reminded of this task, in format YYYY-MM-DDTHH:MM:SS, in UTC timezone. eg: 2019-10-22T10:30:00</summary>
...
public partial class ZwaveJsServices
{
    ...
    ///<param name="refreshAllValues">Whether to refresh all values or just the primary value.</param>
    ...
    ///<param name="twistAssist">Whether the motor should help in locking and unlocking. eg: True</param>
    ///<param name="blockToBlock">Whether the lock should run the motor until it hits resistance. eg: True</param>
...
public partial record ZwaveJsRefreshValueParameters
{
    ...
    ///<summary>Whether to refresh all values or just the primary value.</summary>
...
public partial record ZwaveJsSetLockConfigurationParameters
{
    ...
    ///<summary>Whether the motor should help in locking and unlocking. eg: True</summary>
    [JsonPropertyName("twist_assist")]
    public bool? TwistAssist { get; init; }

    ///<summary>Whether the lock should run the motor until it hits resistance. eg: True</summary>
